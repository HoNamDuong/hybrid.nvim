...
function M.setup(opts)
    ...
    local highlights = {
        ...
        DiffText = { bg = utils.darken(c.diff.change, 0.6, c.bg) },
        DiffTextAdd = { bg = utils.darken(c.diff.add, 0.6, c.bg) },
        ...
        PmenuMatch = { fg = c.match },
        PmenuMatchSel = { fg = c.match, bold = opts.bold },
        PmenuBorder = { link = "FloatBorder" },
        -- PmenuShadow = {},
        -- PmenuShadowThrough = {},
        ComplMatchIns = { fg = c.fg_soft },
        PreInsert = { fg = c.fg_soft },
        -- ComplHint = {},
        -- ComplHintMore = {},
